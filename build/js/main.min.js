...
window.addEventListener('DOMContentLoaded', function () {
  // Utils
  // ---------------------------------
  var toggles = document.querySelectorAll('.tabs__toggle');
  var tabs = document.querySelector('.tabs__head');
  var tabsBody = document.querySelector('.tabs__body');
  var tabsContent = document.querySelectorAll('.tabs__content');
  var anchor = document.querySelector('a[href="#sub"]');
  var video = document.querySelector('.gym__video');
  var playButton = document.querySelector('.gym__play-btn');
  var videoImg = document.querySelector('.gym__video-img');
  ...
  if (tabs) {
    tabs.addEventListener('click', function (evt) {
      var currentToggle = evt.target;
      var tabId = currentToggle.getAttribute('data-tab');
  ...
  swiper__WEBPACK_IMPORTED_MODULE_2__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_2__["Keyboard"]]);
  ...
  var carousel = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.carousel', {
    autoHeight: true,
    observer: true,
    observeParents: true,
    direction: 'horizontal',
